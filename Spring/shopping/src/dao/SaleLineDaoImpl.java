...
public class SaleLineDaoImpl implements SaleLineDao {
	...
	public void create(SaleLine saleLine) {
		this.template.update(SaleLineDaoImpl.INSERT, saleLine.getSale().getSaleId(), saleLine.getSaleLineId(), saleLine.getItem().getItemId(), saleLine.getQuantity(), saleLine.getUpdateTime());
	}
}
